...
class Game {
	...
	//备份游戏
	public GameMemento createMemnto() {
...
public class MementoPattern {
	...
	public static void main(String[] args) {
		...
		System.out.println("游戏备份开始");
		GameMemento memento = game.createMemnto();
		Caretaker ct = new Caretaker();
		ct.setMemento(memento);
		System.out.println("游戏备份结束");
		System.out.println("开始游戏,当前英雄生命值" + game.gethState().getHP());
		game.play();
		System.out.println("游戏结束,当前英雄生命值" + game.gethState().getHP());
		System.out.println("开始还原备份");
		game.restore(ct.getMemento());
		System.out.println("开始还原结束");
		System.out.println("还原结束,当前英雄生命值" + game.gethState().getHP());
	}
